...
namespace VerifyToken
{
    ...
    public class VerifyToken : IHttpHandler, IRequiresSessionState, IRouteHandler
    {
        ...
        static public string CLIENT_ID = "480450238869-c423m2qmrv2o34tg40d7c6t4i755ks8n.apps.googleusercontent.com";
            ...
            if (idToken != null)
            {
                ...
                }
                {
                    ...
                    TokenValidationParameters tvp = new TokenValidationParameters()
                    {
                        ...
                        ValidateAudience = (CLIENT_ID != "480450238869-c423m2qmrv2o34tg40d7c6t4i755ks8n.apps.googleusercontent.com"), // check the client ID
